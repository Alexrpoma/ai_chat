...
class ChatRequest(BaseModel):
    ...
    prompt: str = Field(..., description="The user's current question or entry.")
...
class ChatResponse(BaseModel):
    ...
    # response: str = Field(..., description="The response generated by Agent Alva.")
    partyId: Optional[str] = Field(
        None,
        description="Unique identifier of the client/user."
    )
    ...
    content: str = Field(
        ...,
        description="Response or content generated by the agent."
    )
    contentType: str = Field(
        "text",
        description="The content type. Default is 'text' for conversational responses."
    )